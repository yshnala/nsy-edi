...
public class Edi850ApiService {
	...
	private String iv= UniqueNumberGenerator.generateUniqueMillis(area, sys);
	
	
	
	static final Logger logger = LoggerFactory.getLogger(Edi850ApiService.class);
...
//			//呼叫新 WEB API
			Edi850ApiService rest = new Edi850ApiService();
